...
There is no way to save the state of a random number generator in R. Really. So I could either use a different seed for each time step or use parallel generation. The latter seems safer and not a problem when there are $10^192$ or so streams.
