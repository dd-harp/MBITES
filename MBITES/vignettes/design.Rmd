...
There are several sources of information about this code. This code is described in a research paper, Wu, Sean L., et al. "Vector bionomics and vectorial capacity as emergent properties of mosquito behaviors and ecology." PLoS computational biology 16.4 (2020): e1007446. That paper details the model. The code, itself, has comments about what different parts represent. In this same repository, outside of the MBITES project directory, are examples of how to use the code. Despite all of that, I'd like to sketch the code in a different way.

This document will summarize the structure of the code, meaning its R6 class structure, because that's how it's composed. It will also look at the sequence of calls that happen during a simulation time step. By the end of this, I hope to have a sense of how the code works.
