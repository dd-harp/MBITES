...
1. Keep current behavior but move oogenesis code into a class.

   The challenge for this is that the oogenesis code is called both from the bout-based time step and from the update-state part of the time step. It's also initialized in more than one place. There is a fair amount to track down and no testing code.

2. Create a new class that represents newer oogenesis math.

3. Create a substitute for the `Aqua_Emerge` class.
